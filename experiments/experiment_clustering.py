...
from core.recommenders.clustering import recommend_movies_from_csv
...
if __name__ == "__main__":
    ...
    print("Results saved to clustering_eval_results.csv")
    # Plot the metrics in a line chart
    plot_precision_recall_ndcg(
        results_df, 
        title="Clustering Recommender Performance", 
        filename="clustering_precision_recall_ndcg.png"
    )
    ...
    summary_path = "clustering_eval_summary.csv"
