...
import django
django.setup()
# Import the content based model and helper functions
from core.recommenders.content_based import recommend_movies_from_csv
...
if __name__ == "__main__":
    ...
    results_df.to_csv("content_eval_results.csv", index=False)
    print("Results saved to content_eval_results.csv")
    # Plot the metrics in a line chart
    plot_precision_recall_ndcg(
        results_df,
        title="Content-Based Recommender Performance",
        filename="content_precision_recall_ndcg.png"
    )
    ...
    summary_path = "content_eval_summary.csv"
